...
class Round extends Component {
  ...
  render() {
    ...
    const {moves, round} = this.props;
    return (
      <div className="round">
        <div className="round__title"><b>{player.name}'s</b> Turn</div>
        <div className="round__title round__title--right"><b>{ordinalIndicator(round)}</b> Round</div>
        <Turn {...{player, turn, moves}}
          onEnd={this.handleTurnEnd}
        /> 
      </div>
    );
  }
